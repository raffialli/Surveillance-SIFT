...
# Load Data
train_dataset = ImageFolder(root=train_path)  # Removed transform=transform
val_dataset = ImageFolder(root=val_path)  # Removed transform=transform


# Handle class imbalance
class_count = [4782, 10347]
