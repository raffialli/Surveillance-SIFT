...
folder_path = r"E:\TensorFlow\20230301PM"

# Initialize an empty list to store all mp4 files
all_files = []

# Walk through directory, including all subdirectories
...
# Now all_files contains the paths of all .mp4 files in the folder and its subfolders
